...
O desafio consiste em criar uma aplicação para armazenar transações financeiras de entrada e saída, que deve permitir o cadastro e a listagem dessas transações. O desafio deve ser feito em **Node.js e Typescript**, mas dessa vez incluindo o uso de banco de dados com o TypeORM e envio de arquivos com o Multer.
